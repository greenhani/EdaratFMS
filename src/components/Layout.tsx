          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="flex items-center space-x-3">
                <motion.div 
                  className="w-10 h-10 rounded-2xl overflow-hidden shadow-neon"
                ...
                <div className="hidden sm:block">
                  <h1 className="text-xl font-bold text-gray-900 dark:text-white">EDARAT FMS</h1>
                  <p className="text-xs text-gray-600 dark:text-white/70">Filing Management System</p>
                </div>
              </div>
            </motion.div>
