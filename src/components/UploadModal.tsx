...
import { X, Upload, FileText, CheckCircle, AlertCircle, Plus, Trash2 } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              >
                <Upload className={`w-12 h-12 text-gray-400 mx-auto mb-4 transform transition-all duration-200 ease-out ${
                  dragActive ? 'scale-110 text-teal-500' : ''
                }`} />
                ...
                <label
                  htmlFor="file-upload"
                  className="inline-flex items-center px-4 py-2 bg-teal-600 text-white rounded-sm hover:bg-teal-700 transition-all duration-200 ease-out cursor-pointer text-sm font-medium transform hover:scale-105 hover:shadow-lg"
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-sm text-sm focus:ring-1 focus:ring-teal-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      {file.metadata?.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="inline-flex items-center px-2 py-1 bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400 text-xs rounded-sm"
                        >
                          {tag}
                          <button
          ...
          <div className="flex space-x-3">
            ...
            {currentStep === 'upload' && allFilesCompleted && (
              <button
                ...
                className="px-4 py-2 bg-teal-600 text-white rounded-sm hover:bg-teal-700 transition-all duration-200 ease-out text-sm font-medium transform hover:scale-105 hover:shadow-lg"
              >
                Continue
              </button>
            )}
