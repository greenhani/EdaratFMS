            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <Dialog.Description className="text-orange-100 text-sm">
                    Provide feedback on this document
                  </Dialog.Description>
                </div>
              </div>
              <Dialog.Close 
                className="p-2 text-orange-100 hover:text-white hover:bg-white/10 rounded-xl transition-all duration-200 transform hover:scale-110 hover:rotate-90"
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <div className="flex items-center justify-end space-x-3">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-orange-600 text-white rounded-xl hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-sm font-medium"
              >
                {isSubmitting ? (
                  <>
