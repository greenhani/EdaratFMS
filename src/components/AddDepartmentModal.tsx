          ...
          <div className="p-6 bg-gradient-to-r from-teal-600 to-emerald-600 text-white">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <Dialog.Title className="text-lg font-bold">Add New Department</Dialog.Title>
                  <Dialog.Description className="text-teal-100 text-sm">
                    Create a new department for document organization
                  </Dialog.Description>
                </div>
              </div>
              <Dialog.Close 
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            ...
            <div className="flex items-center justify-end space-x-3">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-teal-600 text-white rounded-xl hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-sm font-medium"
              >
                {isSubmitting ? (
                  <>
